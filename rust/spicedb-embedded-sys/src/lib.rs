...
pub mod memory_transport {
    ...
    pub use crate::memory::{
        check_bulk_permissions, check_permission, delete_relationships, expand_permission_tree,
        read_schema, write_relationships, write_schema, RpcError, RpcResult,
    };
}

use std::os::raw::{c_char, c_int, c_ulonglong, c_uchar};
...
unsafe extern "C" {
    ...
    /// Frees a byte buffer returned by `spicedb_permissions_check_permission` (or other future RPC FFI functions).
    pub fn spicedb_free_bytes(ptr: *mut std::ffi::c_void);
    ...
    pub fn spicedb_permissions_check_permission(
        handle: c_ulonglong,
    ...
    pub fn spicedb_permissions_write_relationships(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
    ...
    pub fn spicedb_schema_write_schema(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
    ...
    pub fn spicedb_permissions_delete_relationships(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
    ...
    pub fn spicedb_permissions_check_bulk_permissions(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
    ...
    pub fn spicedb_permissions_expand_permission_tree(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
    ...
    pub fn spicedb_schema_read_schema(
        handle: c_ulonglong,
        request_bytes: *const c_uchar,
        request_len: c_int,
        out_response_bytes: *mut *mut c_uchar,
